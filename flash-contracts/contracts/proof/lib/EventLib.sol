...
import {RLPWriter} from "@eth-optimism/contracts-bedrock/contracts/libraries/rlp/RLPWriter.sol";
...
library EventLib {
    ...
    function getEventTopic(
        ...
        require(bytes32(topics[0].readUint256()) == eventSignature_, "EL: invalid event signature");
